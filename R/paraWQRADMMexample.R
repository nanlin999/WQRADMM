...
#' @param rep The number of repeated observations for each subject
...
#'
#' k = 3
#' paraWQR = paraWQRADMMCPP(X, Y, K[k], rep, tau, FALSE, "WQR", "ar1")
...
paraWQRADMMCPP <- function(x, y, K, rep, tau, intercept, esttype, corrtype, rhoCQR = 5, rhoWQR = 5, eps = 1e-03, epsw = 1e-06, maxstep = 1e03, maxstepw = 1e02) {
