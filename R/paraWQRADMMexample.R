...
#'
#' k = 10
#' paraWQR = paraWQRADMM(X, Y, k, rep, tau, TRUE, "WQR", TRUE)
...
paraWQRADMM <- function(x, y, K, rep, tau, intercept, esttype, warmstart = TRUE, corrtype = "ar1", rhoCQR = 1, rhoWQR = 1, eps = 1e-04, epsw = 1e-06, maxstep = 5000, maxstepw = 100) {
  .Call('_WQRADMM_paraWQRADMM', PACKAGE = 'WQRADMM', x, y, K, rep, tau, intercept, esttype, warmstart, corrtype, rhoCQR, rhoWQR, eps, epsw, maxstep, maxstepw)
}
