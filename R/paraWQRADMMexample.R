...
#' }
#' beta = rnorm(p)
#' cov_e = gcov(n, rho_e, "exchangeable")
...
#' k = 3
#'
#' paraCQR = paraWQRADMM(X, Y, K[k], rep, tau, FALSE, "CQR")
...
paraWQRADMM <- function(x, y, K, rep, tau, intercept, esttype, corrtype = "exchangeable", rho_CQR = 1, rho_WQR = 1, eps = 1e-04, epsw = 1e-06, maxstep = 1000, maxstepw = 1000) {
