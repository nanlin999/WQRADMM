...
// [[Rcpp::export]]
Rcpp::List WQRADMM(arma::mat x, arma::vec y, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "exchangeable", double rho_CQR = 1, double rho_WQR = 1, double eps = 1e-04, double epsw = 1e-06, int maxstep = 1000, int maxstepw = 1000){
...
// [[Rcpp::export]]
Rcpp::List paraWQRADMM(arma::mat x, arma::vec y, int K, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "exchangeable", double rho_CQR = 1, double rho_WQR = 1, double eps = 1e-04, double epsw = 1e-06, int maxstep = 1000, int maxstepw = 1000){
