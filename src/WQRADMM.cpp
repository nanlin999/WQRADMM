...
// [[Rcpp::export]]
Rcpp::List WQRADMMCPP(arma::mat x, arma::vec y, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "exchangeable", double rho_CQR = 5, double rho_WQR = 5, double eps = 1e-03, double epsw = 1e-06, int maxstep = 1e03, int maxstepw = 1e02){
  ...
  Rcpp::List final;
  if(esttype == "CQR"){
    result_CQR = WQRCPP(x, y, tau, rho_CQR, eps, maxstep, intercept);
  ...
  if(esttype == "WQR"){
    ...
    result_WQR = WQRCPP(xw, yw, tau, rho_WQR, eps, maxstep, intercept);
    double Tsum = 0;
...
arma::vec paraWQRCPP(arma::mat x, arma::vec y, arma::vec rep, int K, double tau, double rho, double eps, int maxstep, bool intercept){
...
// [[Rcpp::export]]
Rcpp::List paraWQRADMMCPP(arma::mat x, arma::vec y, int K, arma::vec rep, double tau, bool intercept, String esttype, String corrtype = "exchangeable", double rho_CQR = 5, double rho_WQR = 5, double eps = 1e-03, double epsw = 1e-06, int maxstep = 1e03, int maxstepw = 1e02){
  ...
  Rcpp::List final;
  if(esttype == "CQR"){
    pararesult_CQR = paraWQRCPP(x, y, rep, K, tau, rho_CQR, eps, maxstep, intercept);
  ...
  if(esttype == "WQR"){
    ...
    pararesult_WQR = paraWQRCPP(xw, yw, rep, K, tau, rho_WQR, eps, maxstep, intercept);
    double Tsum = 0;
